...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.color = nil;
		self.labelFont = [UIFont fontWithName:@"NotoSans-Bold" size:kLabelFontSize];
		self.labelColor = [UIColor whiteColor];
		self.detailsLabelFont = [UIFont fontWithName:@"NotoSans-Bold" size:kDetailsLabelFontSize];
